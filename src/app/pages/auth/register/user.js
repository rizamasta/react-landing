            ...
            <div className="limiter">
                <div className="container-login100">
                    <div className="login100-more" >
                        <img src={CartecLogo} alt="logo" style={{ position: "relative", top: '35%', left: '40%', height: 40 }} />
                    </div>
                    ...
                    <div className="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                        <form className="login100-classNamem validate-form">
                            ...
                            <div className="wrap-input100 validate-input" data-validate="Repeat Password is required">
                                ...
                                <input className="input100" type="password" name="repeat-pass" placeholder="*************" />
                                <span className="focus-input100"></span>
                            </div>
                            ...
                            <div className="container-login100-form-btn">
                                <div className="wrap-login100-form-btn">
                                    <div className="login100-form-bgbtn" style={{ backgroundColor: grey[500] }}></div>
                                    <button className="login100-form-btn">
                                        Daftar
							</button>
                                </div>

                                <Link to="/users/login" className="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
                                    Masuk
